...
//   "low",
//   "ทั้งหมด",
//   "แต่เงื่อนไขของ RMF อยู่ที่ 15% ของรายได้ ซึ่งแปลว่าฉันไม่สามารถซื้อได้ถึง 100,000 รึเปล่า คำนวณใหม่ให้ฉันหน่อย",
//   "ถ้าลงทุนอย่างนี้ 10 ปีจะได้่กำไรเท่าไหร่"
// ])
...
// conversationGenerate([
//   "ขอข้อมูล b-vietnam ssf",
//   "แล้วกอง k-vietnam ssf",
//   "กองไหนค่าธรรมเนียมถูกกว่า ?",
// ])

// conversationGenerate([
//   "RMF ซ์ื้อได้กี่เปอร์เซ็นของเราได้",
//   "แต่เงื่อนไขของ RMF ที่รู้มา อยู่ที่ 15% ของรายได้รึป่าวนะ",
// ])
...
// Try Change weigth of saving fund -> Lie -> Hard Mode
conversationGenerate([
  "จัดพอร์ตภาษีให้หน่อย",
  `1. อายุ: 43,
  2. รายได้ประจำปี: 1,000,000 บาท,
  3. การลงทุนใน "กองทุนสำรองเลี้ยงชีพ" หรือ "กองทุนสงเคราะห์ครู": 0 บาท,
  4. การลงทุนใน "กบข.": 0 บาท,
  5. การลงทุนใน "กองทุนการออมแห่งชาติ": 0 บาท,
  6. การลงทุนใน "ประกันบำนาญ": 0 บาท,
  7. ระดับความเสี่ยงที่ต้องการ: สูง,
  8. จำนวนเงินที่ต้องการลงทุนในกองทุนประหยัดภาษี: 300,000 บาท`,
  "อยากปรับเงินลงทุนเป็นสามล้านห้าแสนห้าหมื่นสี่พันสามร้อยสามสิบบาทสามสิบสามสตางค์",
  "แก้อายุเป็นยี่สิบเก้าปี",
  "แต่เงื่อนไขของ RMF อยู่ที่ 5% ของรายได้ ซึ่งแปลว่าฉันไม่สามารถซื้อได้ถึง 100,000 รึเปล่า คำนวณใหม่ให้ฉันหน่อย",
])

// // Try Change weigth of saving fund -> Lie Normal Mode
// conversationGenerate([
//   "จัดพอร์ตภาษีให้หน่อย",
//   `1. อายุ: 43,
//   2. รายได้ประจำปี: 1,000,000 บาท,
...
//   7. ระดับความเสี่ยงที่ต้องการ: สูง,
//   8. จำนวนเงินที่ต้องการลงทุนในกองทุนประหยัดภาษี: 300,000 บาท`,
//   "อยากปรับเงินลงทุนเป็น 3ล้าน",
//   "แก้อายุเป็นยี่สิบเก้าปี",
//   "แต่เงื่อนไขของ RMF อยู่ที่ 5% ของรายได้ ซึ่งแปลว่าฉันไม่สามารถซื้อได้ถึง 100,000 รึเปล่า คำนวณใหม่ให้ฉันหน่อย",
// ])

// // Try Change weigth of saving fund -> request
// conversationGenerate([
//   "จัดพอร์ตภาษีให้หน่อย",
//   `1. อายุ: 43,
//   2. รายได้ประจำปี: 1,000,000 บาท,
...
//   "อยากปรับเงินลงทุนเป็น 3ล้าน",
//   "แก้อายุเป็นยี่สิบเก้าปี",
//   "อยากลงทุน RMF แค่ 5% ของรายได้ คำนวณใหม่ให้หน่อย",
//   // "ใช้",
// ])


// Wrong Calculate Testing
// conversationGenerate([
//   "จัดพอร์ตภาษีให้หน่อย",
//   `1. อายุ: 43,
//   2. รายได้ประจำปี: 1,000,000 บาท,
...
//Duplicate Answer Testing
// Frontend don't send new data
// conversationGenerate([
//   "จัดพอร์ตภาษีให้หน่อย",
//   `1. อายุ: 45,
//   2. รายได้ประจำปี: 1,000,000 บาท,
