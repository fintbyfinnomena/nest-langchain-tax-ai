...
const NO_DESIRED_AMOUNT_LOGIC = `เนื่องจากนักลงทุนไม่ได้ระบุงบประมาณที่ต้องการลงทุน Charlie จะแนะนำพอร์ตโดยใช้**จำนวนเงินสูงสุดที่ลงทุนได้** นักลงทุนโปรดตรวจสอบภาษีที่คุณต้องเสียให้เรียบร้อยก่อน (แนะนำแอปพลิเคชัน [iTAX](https://www.itax.in.th/)) หากคุณไม่ต้องเสียภาษี เราไม่แนะนำให้ซื้อกองทุนเหล่านี้ เนื่องจากในอนาคตหากมีกำไรที่เกิดจากการขายกองทุนเหล่านี้คุณจำเป็นที่จะต้องเสียภาษีในส่วนกำไรที่ได้ด้วย


`;
const BELOW_45_CONSTRUCTION_LOGIC = `ในการลงทุนของผู้เสียภาษีที่อายุ 45 ปีหรือต่ำกว่า Charlie จะแนะนำให้ลงทุนในกองทุน SSF ให้เต็มสิทธิ์ ก่อนจะลงทุนส่วนที่เหลือในกองทุน RMF และ TESG เนื่องจากตามกฎหมาย กองทุนประเภทนี้ไม่จำเป็นต้องถือถึงอายุ 55 ถึงจะขายกองทุนเหล่านั้นออกมาได้ เพียงแค่ถือเป็นระยะเวลา 10 ปีก็สามารถขายออกมาได้ทันที (ตัวอย่าง ผู้เสียภาษีอายุ 44 ปี สามารถขายกองทุนนำเงินออกมาได้ตั้งแต่อายุ 54 ปี) นอกจากนี้กองทุนประเภท SSF มีความยืดหยุ่นกว่าเนื่องจากไม่มีเงื่อนไขที่ต้องลงทุนต่อเนื่องทุกปีแบบ RMF อีกด้วย

ส่วนของกอง TESG เราแนะนำไว้ท้ายสุดเนื่องจากเป็นกองทุนที่ไม่มีความยืดหยุ่นในประเภทสินทรัพย์ที่ลงทุนได้`;
const ABOVE_45_CONSTRUCTION_LOGIC = `ในการลงทุนของผู้เสียภาษีที่อายุมากกว่า 45 ปี Charlie จะแนะนำให้ลงทุนในกองทุน RMF ให้เต็มสิทธิ์ ก่อนจะลงทุนส่วนที่เหลือในกองทุน SSF และ TESG เนื่องจากมีโอกาสที่จะขายกองทุนเหล่านี้ออกมาในระยะเวลาที่ต่ำกว่า 10 ปีของ SSF ได้ จากเงื่อนไขอายุที่เข้าใกล้ 55 ปี (ตัวอย่างผู้เสียภาษีอายุ 46 ปี สามารถขายกองทุนนำเงินออกมาได้ตั้งแต่อายุ 55 ปี ซึ่งใช้เวลาแค่ 9 ปีเท่านั้น)
...
export function suggestPortfolioAllocation(
  ...
  result.reason +=
    (input.desiredAmount ? '' : NO_DESIRED_AMOUNT_LOGIC) +
...
export function calculateMaximumAllowAmount(
  ...
  // Thai ESG: ตามจริงหรือไม่เกิน 30% ของรายได้ทั้งปี และไม่เกิน 300,000 บาท
