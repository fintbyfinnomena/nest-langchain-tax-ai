...
- If user ask about detail of fund types which is RMF/SSF/TESG/ThaiESG/LTF, route to "tax_saving_fund_knowledge" agent.
- If user ask about Finnomena (ฟินโนมีนา) / Promotion /  Events / Management / FAQ / how to open account / how to invest, route to "finnomena_knowledge" agent.
